...
function reiscout_address_menu() {
    ...
    items['purchased-addresses'] = {
        ...
        page_callback: 'reiscout_address_purchased_list_page'
    };
 ...
 */
function reiscout_address_purchased_list_page() {
    try {
        var content = {};
        ...
        content['address_list'] = {
            ...
            row_callback: 'reiscout_address_purchased_list_row',
            empty_callback: 'reiscout_address_purchased_list_empty',
            attributes: {
                id: 'reiscout_address_purchased_list_view'
            }
        };
      ...
      console.log('reiscout_address_purchased_list_page - ' + error);
    }
}
 ...
 */
function reiscout_address_purchased_list_row(view, row) {
    try {
        image = theme('image', {
          path: row.image.src,
          alt: row.image.alt
    ...
    catch (error) { console.log('reiscout_address_purchased_list_row - ' + error); }
}

/**
 * The callback to display info if there are no items to display.
 */
function reiscout_address_purchased_list_empty(view) {
